    ...
    <main>
        ...
        <div className="grid items-start gap-8 mb-12 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-4 text-gray-700">
              PrintHub is a practice project that simulates a platform the go-to platform for 3D printing enthusiasts, makers, and professional designers to share and discover amazing STL files for 3D printing.
            </p>
        ...
        <div className="px-6 mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 md:gap-0 md:grid-cols-3">
            ...
            <article className="p-6 bg-white">
              ...
              <p className="text-gray-600">
                Most models are free to download, with oiptional premium features for power users.
              </p>
            </article>
          </div>
        </div>
      ...
      <section className="container max-w-3xl px-4 py-8 mx-auto">
        <div className="prose max-w-none">
          ...
          <p className="mb-4 text-gray-700">
            At PrintHub, we believe that 3D printing is revolutionizing the way we create, prototype, and manufacture. Our platform serves as a bridge between designers and makers, enabling the sharing of knowledge and creativity that pushes the boundaries of what&apos;s possible with 3D printing.
          </p>
          <p className="text-gray-700">
            Whether you&apos;re a hobbyist looking for your next weekend project, an educator seeking teaching materials, or a professional designer wanting to share your creations,PrintHub provides the tools and community to support your journey in 3D printing.
          </p>
        </div>
      </section>
    </main>
